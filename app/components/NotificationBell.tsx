...
import { Button } from "../../src/components/ui/button"; // Needed for trigger
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    <DropdownMenu onOpenChange={handleOpenChange}>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 block h-4 w-4 transform translate-x-1/2 -translate-y-1/2 rounded-full ring-1 ring-background bg-primary text-primary-foreground text-xs items-center justify-center text-[10px]">
              {unreadCount}
            </span>
          )}
        </Button>
