...
"[project]/src/app/contexts/OrderContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/utils.ts [app-client] (ecmascript)"); // Utility to create unique IDs
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
const OrderProvider = ({ children })=>{
    ...
    const placeOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrderProvider.useCallback[placeOrder]": (cartItems, totalDetails, shippingAddress, billingAddress, userId)=>{
            const newOrder = {
                id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateOrderId"])(),
                userId: userId,
                items: [
                    ...cartItems
                ],
            ...
            setOrders({
                "OrderProvider.useCallback[placeOrder]": (prevOrders)=>[
                        ...prevOrders,
                        newOrder
                    ]
            }["OrderProvider.useCallback[placeOrder]"]);
    ...
    }["OrderProvider.useCallback[placeOrder]"], []); // No dependencies needed for this simulation
    // Function to retrieve a specific order
    const getOrderById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrderProvider.useCallback[getOrderById]": (orderId)=>{
            return orders.find({
                "OrderProvider.useCallback[getOrderById]": (order)=>order.id === orderId
            }["OrderProvider.useCallback[getOrderById]"]);
        }
    }["OrderProvider.useCallback[getOrderById]"], [
        orders
    ]);
    ...
    const updateOrderStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrderProvider.useCallback[updateOrderStatus]": (orderId, newStatus)=>{
            setOrders({
                "OrderProvider.useCallback[updateOrderStatus]": (prevOrders)=>prevOrders.map({
                        "OrderProvider.useCallback[updateOrderStatus]": (order)=>{
                            if (order.id === orderId) {
                    ...
                    }["OrderProvider.useCallback[updateOrderStatus]"])
            }["OrderProvider.useCallback[updateOrderStatus]"]);
        }
    }["OrderProvider.useCallback[updateOrderStatus]"], []);
    // Memoize the context value
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrderProvider.useMemo[value]": ()=>({
                orders,
                placeOrder,
                getOrderById,
                updateOrderStatus
...
_s(OrderProvider, "gR+Ft2xrdH0MYNOhA3NjXoEiigA=");
_c = OrderProvider;
const useOrders = ()=>{
    _s1();
...
//# sourceMappingURL=_f765efeb._.js.map